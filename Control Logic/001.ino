...
void setup() {
  ...
  // 杯身旋转设定
    myservo.attach(7);//(11)  // attaches the servo on pin 9 to the servo object
  ...
  //吸管夹爪旋转设定
    ...
    delay(3000);
  // 滑台旋转舵机设定
    myservo4.attach(8);  //(11) attaches the servo on pin 9 to the servo object
...
void wholeMotion(){
 ...
 // 吸管夹紧
  ...
  // myStepper.step(-stepsPerRevolution*down2);
  // delay(500);
